        ...
        >
            ...
            >
                ...
                <div class="grid grid-cols-7 mb-3">
                    <div
                        v-for="(day, index) in datePicker.datePickerDays"
                        :key="index"
                        class="px-0.5"
                    >
                        <div
                            class="text-xs font-medium text-center text-gray-800 dark:text-neutral-300"
                        >
                            {{ day }}
                        </div>
                    </div>
                ...
                <div class="grid grid-cols-7">
                    ...
                    ></div>
                    <div
                        v-for="(day, dayIndex) in datePicker.datePickerDaysInMonth"
                        :key="dayIndex"
                        ...
                        <div
                            ...
                            :class="{
                                ...
                                'text-gray-600 dark:text-neutral-400 hover:bg-neutral-200 dark:hover:text-neutral-100 dark:hover:bg-neutral-900':
                                    datePicker.datePickerIsToday(day) == false &&
                                    datePicker.datePickerIsSelectedDate(day) == false,
