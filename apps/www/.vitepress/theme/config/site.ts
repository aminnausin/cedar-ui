export const siteConfig = {
    name: 'cedar-ui',
    url: 'https://cedar-ui.nausin.me',
    // ogImage: 'https://shadcn-vue.com/og.png',
    description: 'Thoughtfully designed Vue components built with Tailwind CSS.',
    links: {
        github: 'https://github.com/aminnausin/cedar-ui',
    },
    keywords: 'Vue,Vue Components,TailwindCSS',
};
