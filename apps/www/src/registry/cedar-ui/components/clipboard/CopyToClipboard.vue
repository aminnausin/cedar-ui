...
<template>
    <div class="flex justify-between gap-4">
        <TextInput class="h-8!" v-model="text" disabled />
        <div class="relative z-20 flex items-center">
            ...
            >
                <div v-if="clipboard.copyNotification.value" class="absolute left-0" v-cloak>
                    <div
                        class="-ml-1.5 flex h-7 -translate-x-full items-center rounded border-r border-green-500 bg-green-500 px-3 text-xs text-white"
                    >
                        <span>Copied!</span>
            ...
            <ButtonIcon
                ...
                :class="
                    cn('group bg-surface-3 hover:text-foreground-0 text-foreground-1 text-xs focus:ring-green-600/50', {
