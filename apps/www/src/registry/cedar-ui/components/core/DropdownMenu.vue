...
import type { DropdownMenuItem } from '@/types/cedar-ui.ts';

import { computed, nextTick, onMounted, onUnmounted, ref, useTemplateRef, watch } from 'vue';
import { ProiconsSettings, LucideUserPlus, LucideLogOut, LucideLogIn } from '@/registry/cedar-ui/components/icons';
import { OnClickOutside } from '@vueuse/components';

import DropdownItem from '@/registry/cedar-ui/components/core/DropdownItem.vue';
...
const dropDownItemsAuth = computed<DropdownMenuItem[][]>(() => {
    return [[{ ...defaults, name: 'logout', url: '/logout', text: 'Log out', icon: LucideLogOut, shortcut: '⇧⌘Q' }]];
});
