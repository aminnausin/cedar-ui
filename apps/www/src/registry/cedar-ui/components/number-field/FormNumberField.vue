    ...
    <span class="relative mt-1 inline-flex w-full text-sm">
        ...
        <span class="absolute top-0 right-0 flex h-full w-12 flex-col">
            <ButtonIcon
                ...
                class="focus:ring-primary hover:bg-overlay-border/50 h-1/2 rounded-none rounded-tr-md focus:ring-2"
            ...
            <ButtonIcon
                @click.prevent.stop="step(-1)"
                class="focus:ring-primary hover:bg-overlay-border/50 h-1/2 rounded-none rounded-br-md focus:ring-2"
