    ...
    <div class="relative flex">
        ...
        >
            <UseFocusTrap
                v-if="popoverOpen"
                :class="[
                    'border-overlay-border bg-overlay-2-t absolute z-50 w-[300px] max-w-lg rounded-md border p-4 shadow-xs backdrop-blur-xs',
                    popoverClass,
                    '-translate-x-1/2',
            ...
            >
                ...
                >
                    ...
                    >
                        <div
                            :class="[
                                'border-overlay-border bg-overlay-2-t h-2.5 w-2.5 transform rounded-sm border-l',
                                popoverPosition === 'bottom'
                                    ? 'origin-bottom-left rotate-45 border-t'
                                    : 'origin-top-left -rotate-45 border-b',
                            ]"
                        ></div>
                    </div>
                    <slot name="content">
