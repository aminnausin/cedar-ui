...
<template>
    <section class="w-full flex flex-col gap-8">
        <div>
            <p class="mb-2 text-lg font-medium text-center sm:text-left">Position</p>
            <div class="flex flex-wrap gap-4">
                <ButtonText
                    ...
                    @click="
                        ...
                        showToast();
                    "
                    :class="[{ 'ring-neutral-500! dark:ring-neutral-300!': currentPosition == pos }, 'text-sm h-8 ring-1 capitalize']"
                >
                    {{ pos }}
                </ButtonText>
            </div>
        ...
        <div>
            <p class="mb-2 text-lg font-medium text-center sm:text-left">Types</p>
            <div class="flex flex-wrap gap-4">
                <ButtonText
                    v-for="type in types"
                    :key="type"
                    @click="
                        ...
                        showToast();
                    "
                    :class="[{ 'ring-neutral-500! dark:ring-neutral-300!': currentType == type }, 'text-sm h-8 ring-1 capitalize']"
                >
                    {{ type }}
                </ButtonText>
                <ButtonText
                    @click="
                        ...
                        showToast();
                    "
                    :class="[{ 'ring-neutral-500! dark:ring-neutral-300!': withDescription }, 'text-sm h-8 ring-1 capitalize']"
                >
                    With Description
                </ButtonText>
            </div>
